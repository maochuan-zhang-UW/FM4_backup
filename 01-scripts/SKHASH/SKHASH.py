...
appropriate papers.
	Skoumal, R.J., Hardebeck, J.L., & Shearer, P.M. (2024). SKHASH: A Python
		...
		https://doi.org/10.1785/0220230329
...
p_dict={
	...
	'npolmin':15, # mininum number of polarity data (e.g., 8)
	'nmc':30, # number of trials (e.g., 30)
	'maxout':300, # maxout for focal mech. output (e.g., 500)
	...
	'prob_max':0.5, # probability threshold for multiples (e.g., 0.2)
	'max_agap':240.0, # maximum azimuthal gap,eg. 90
	'max_pgap':60.0, # maximum "plungal" gap, eg.60
	...
	'num_cpus':8, # Number of cores to run things in parallel. Set to 0 to use all available, or 1 to run in serial.

	'dang':5, # minimum grid spacing (degrees).
	'nx0':101, # maximum source-station distance bins for look-up tables
	'nd0':19, # maximum source depth bins for look-up tables
	'look_dep':[0,18,1], # minimum source depth, maximum, and interval for the lookup table
	'look_del':[0,100,1], # minimum source-station distance, maximum, and interval for the lookup table
	...
	'default_vert_uncert_km':0.2, # If the vertical uncertainty for an earthquake is missing or negative, this value is used instead when perturbing the source depth.
	'default_horz_uncert_km':0.3, # If the horizontal uncertainty for an earthquake is missing or negative, this value is used instead when perturbing the source hypocenter.
	'default_takeoff_uncert':10.0, # If the precomputed takeoff uncertainty is missing or negative, this value is used instead when perturbing takeoffs
	'default_azimuth_uncert':5.0, # If the precomputed azimuth uncertainty is missing or negative, this value is used instead when perturbing azimuths
