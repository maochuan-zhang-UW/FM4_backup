function [traceZ, traceN, traceE] = obtain_waveforms_all15OBSs(ph2dt, ind_station, st1, st2, p)
% Obtain waveforms for Z, N, E channels in one call
stations = {'AX01A', 'AX02A', 'AX03A', 'AX04A', 'AX05A', 'AX06A', 'AX07A','AX08A','AX09A','AX10A', 'AX11A', 'AX12A', 'AX13A', 'AX14A', 'AX15A'};
channelsZ = {'HHZ', 'ELZ', 'ELZ', 'ELZ', 'ELZ', 'ELZ', 'ELZ','ELZ','HHZ','HHZ','ELZ','HHZ' ,'ELZ','ELZ','HHZ'};
channelsN = {'HH1', 'EL1', 'EL1', 'EL1', 'EL1', 'EL1', 'EL1','EL1','HH1','HH1','EL1','HH1', 'ELZ','ELZ','HHZ'};
channelsE = {'HH2', 'EL2', 'EL2', 'EL2', 'EL2', 'EL2', 'EL2','EL2','HH2','HH2','EL2','HH2', 'ELZ','ELZ','HHZ'};
...
p.dir.data='/Users/mczhang/Documents/GitHub/FM4/01-scripts/data';
% Construct file path
d = ph2dt.on;
...
if ~isempty(trace1)
    ...
    traceZ.data=traceZ.data';
    traceN.data=traceN.data';
    traceE.data=traceE.data';
