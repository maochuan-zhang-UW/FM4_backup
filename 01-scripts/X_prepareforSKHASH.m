...
% Output file name
output_file = '/Users/mczhang/Documents/GitHub/SKHASH/SKHASH/examples/hash3/IN/scsn.stations.txt';
...
for i = 1:length(station_codes)
    ...
    fprintf(fid, '%-4s %-3s %-28s     %8s %10s %5d %s %s %s\n', ...
            ['A' station_codes{i}], channel, site, lat_str, lon_str, ...
...
% Output file name
output_file = '/Users/mczhang/Documents/GitHub/SKHASH/SKHASH/examples/hash3/IN/north3.statcor.txt';
