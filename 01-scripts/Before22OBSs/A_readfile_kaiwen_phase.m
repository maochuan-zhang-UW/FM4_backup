clear;clc;
filename = '/Users/mczhang/Documents/GitHub/FM4/02-data/hypoDD_nll_RT.pha';
% Open the file
    ...
    if startsWith(line, '#')
        ...
        while ischar(nextLine) && ~startsWith(nextLine, '#')
            if ~isempty(nextLine)
                ...
                phase = nextLine(end);      
                if eventCount < 23686
                    arrivalTime = str2num(nextLine(10:24));
                    station = nextLine(7:9);
                else
...
% Close the file
fclose(fid);
save('/Users/mczhang/Documents/GitHub/FM4/02-data/A_Kaiwen.mat','Felix');