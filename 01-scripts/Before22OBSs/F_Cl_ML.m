...
for gp = 3:length(groups) % Process all groups
    ...
    %load('/Users/mczhang/Documents/GitHub/FM4/02-data/Before22OBSs/E_Po/E_All_PoReplaced.mat')
     load('/Users/mczhang/Documents/GitHub/FM3/02-data/E_Po/E_all_MLAxialPo_secondOnly.mat')
    ...
    %save([path,'F_Cl/F_',groups{gp},'.mat'], 'Po_Clu');
     load('/Users/mczhang/Documents/GitHub/FM3/02-data/F_Cl/F_Cl_all_MLAxialPo_secondOnly.mat')
   
    %save('/Users/mczhang/Documents/GitHub/FM4/02-data/Before22OBSs/F_Cl/F_Cl_All_ML.mat', 'Po_Clu');
    disp([groups{gp},'_group numer:',num2str(length(Po_Clu)),', total:',num2str(numbertoknow),', ratio:',num2str(length(Po_Clu)/numbertoknow)]);
    %save(['/Users/mczhang/Documents/GitHub/FM4/02-data/Before22OBSs/F_Cl/F_Cl_' groups{gp} '_new_Cluster_Result.mat'], "results");
end
