...
c     10-18      f9.5   station latitude (degrees, signed)
c     20-29      f10.5  station longitude (degrees, signed)
c     31-35      i5     station elevation (meters)
c     37-38      a2     network code
*
* Modified by William Wilcock (9/24/2007) following EEEH
c
c
...
11       format (a4,1x,a3,1x,f9.5,1x,f10.5,1x,i5,1x,a2)
