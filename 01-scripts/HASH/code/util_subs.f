...
* wsdw start ___________________________
* Comment out since this is normal occurance and is handled "WARNING" is unnecessary
*          print *,'***FPCOOR warning, horz fault, strike undefined'
* wsdw end ___________________________
           del=0.
